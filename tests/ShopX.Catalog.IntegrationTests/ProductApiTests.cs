...
namespace Shopx.Catalog.IntegrationTests
{
    public class ProductApiTests : IClassFixture<CatalogApiFactory>
    {
        ...
        {
            //Arrange
            var createRequest = new { Name = "Test Product1", Price = 99.9m, Stock = 5 };
            ...
            product!.Name.Should().Be("Test Product1");
        ...
        public async Task Update_Product_Should_Change_Values()
        {
            ...
            //Act
            var updateRequest = new {Id=productId, Name = "New Name", Price = 15m, Stock = 10 };
